...
export function ProjectCard({ project, index }: Props) {
  return (
    ...
    >
      ...
      >
        <div className={`h-52 bg-gradient-to-br ${project.coverColor} flex items-center justify-center relative overflow-hidden`}>
          <div className="absolute inset-0 bg-zinc-100/40 dark:bg-zinc-900/40" />
          <span className="relative text-zinc-400 dark:text-zinc-600 text-sm">Cover image</span>
